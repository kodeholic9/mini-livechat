...
// (channel_id, freq, name, mode, capacity)
//   mode: "ptt" | "conference"
// ----------------------------------------------------------------------------
pub const PRESET_CHANNELS: &[(&str, &str, &str, &str, usize)] = &[
    ("CH_0001", "0001", "📢 영업/시연",    "ptt", 20),
    ("CH_0002", "0002", "🤝 스스 파트너스", "ptt", 20),
    ("CH_0003", "0003", "🏠 동천 패밀리",    "ptt", 20),
    ("CH_0004", "0004", "🎙️ 회의실",       "conference", 20),
];
